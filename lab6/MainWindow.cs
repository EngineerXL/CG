...
namespace lab6
{
    unsafe class MainWindow : Gtk.Window
    {
        ...
        [UI] private CheckButton _checkButtonAnimation = null;
        private const float ANIMATION_SPEED = 1f / (1e6f);
        ...
        private void GLArea_Render(object sender, EventArgs a)
        {
            ...
            if (_checkButtonFillPolygons.Active)
            {
                if (_radioButtonSimpleShading.Active)
                {
                    ...
                    if (_checkButtonAnimation.Active)
                    {
        ...
        private void GetLayoutLocations()
        {
            ...
            animateLocation        = gl.GetUniformLocation(shaderProgram, "animate");
        ...
        private void AddToggledEventToDrawingParameters()
        {
            ...
            _checkButtonAnimation.Toggled += CheckButtonAnimation_ToggledEvent;
        ...
        private void GetAllData()
        {
            ...
            gl.Uniform1(timeLocation, _frameClock.FrameTime * ANIMATION_SPEED);
        }
        ...
        private void CheckButtonAnimation_ToggledEvent(object sender, EventArgs args) {
            if (_checkButtonAnimation.Active)
            {
